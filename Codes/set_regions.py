...
if __name__ == '__main__':
    ...
    parser.add_argument('video_path', help="Path of video file", default="../Data/stace_park3.mp4")
    parser.add_argument('--out_file', help="Name of the output file", default="../Results/regions.p")
